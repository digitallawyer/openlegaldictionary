...
body: Thls term, ln Its vulgar acceptation, ls only applled to houses and other buildlugs,
  but in lts origiual, proper, and legal sense it signifies everything that may be
  holden, provided lt be of a permanent nature, whether it be of a substantial and
  sensible, or of an unsubstantial, ideal, kind. Thus, liberum tenementvm, frank tenement,
  or freehold, ls appllcable not only to lands and otber solld objects, but also to
