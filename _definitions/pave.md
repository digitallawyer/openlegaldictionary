...
body: To pave is to cover with stones or brick, or other suitable material, so as
  ...
  and a sidewalk is paved when lt is laid or flagged with flat stones, as well as
  when paved with brick, as ls frequently done. In re Phillips, 60 N. Y. 22; Buell
